...
export default function Login() {
    ...
    return (
        <>
            <Head>
                <title>Login - Website14</title>
                <meta name="description" content="Login to your Website14 client portal" />
                        ...
                        <div className="max-w-md w-full space-y-8">
                            <div>
                                ...
                                <p className="mt-2 text-center text-sm text-gray-600">
                                    Access your projects and manage your website
                                </p>
                            </div>
                            ...
                            <form className="mt-8 space-y-6" onSubmit={handleEmailLogin}>
                                ...
                                <div>
                                    <button
                                        ...
                                        disabled={loading}
                                        className="group relative w-full flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
